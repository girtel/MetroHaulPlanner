...
public class OpticalSpectrumManager
{
     ...
     * @return see above. If no idle range is found, Optional.empty is returned. Note that only the first slot is returned, but 
     * availability is guaranteed for all the contigous set of slots.
     */
